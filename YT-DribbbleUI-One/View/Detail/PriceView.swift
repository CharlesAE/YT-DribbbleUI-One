...
class PriceView: UIView {
    ...
    func configDiscountText(_ discount: String) -> NSAttributedString{
    
        let attributedText = NSMutableAttributedString(attributedString: NSAttributedString(string: discount))
    ...
    func manageData(){
        ...
        beforePrice.priceLabel.attributedText = configDiscountText(String(format: "%.1f", discount))
        }
}
extension UIView {
